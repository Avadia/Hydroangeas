...
public interface Node extends ISnowflake {
    ...
    default long getMemoryLong() {
        return Long.parseLong(getMemory());
    }

    String getMemoryOverallocate();

    default long getMemoryOverallocateLong() {
        return Long.parseLong(getMemoryOverallocate());
    }

    String getDisk();

    default long getDiskLong() {
        return Long.parseLong(getDisk());
    }

    String getDiskOverallocate();

    default long getDiskOverallocateLong() {
        return Long.parseLong(getDiskOverallocate());
    }

    String getUploadLimit();

    default long getUploadLimitLong() {
        return Long.parseLong(getUploadLimit());
    }
